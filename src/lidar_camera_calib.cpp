...
//  cv::imwrite("/home/mcqueen-zero/WorkProjects/MFO_SLAM/datasets/My_Self/hat/calibration/image/init.png", init_img);
  cv::waitKey(1000);
...
//  cv::imwrite("/home/mcqueen-zero/WorkProjects/MFO_SLAM/datasets/My_Self/hat/calibration/image/opt.png", opt_img);
  cv::waitKey(1000);
